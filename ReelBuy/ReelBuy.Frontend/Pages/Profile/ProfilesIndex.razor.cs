...
public partial class ProfilesIndex
{
    ...
    {
        var responseHppt = await Repository.GetAsync<List<Profiles>>("api/profiles");
        ...
        Profiles = responseHppt.Response!;
    }

    private async Task DeleteAsync(Profiles profile)
    {
        var result = await SweetAlertService.FireAsync(new SweetAlertOptions
        {
            Title = Localizer["Confirmation"],
            Text = string.Format(Localizer["DeleteConfirm"], Localizer["Profiles"], profile.Name),
        ...
        var responseHttp = await Repository.DeleteAsync($"api/profiles/{profile.Id}");
