...
public partial class CategoriesIndex
{
    ...
    public List<ReelBuy.Shared.Entities.Category>? Categories { get; set; }
    ...
    {
        var responseHppt = await Repository.GetAsync<List<ReelBuy.Shared.Entities.Category>>("api/categories");
    ...
    private async Task DeleteAsync(ReelBuy.Shared.Entities.Category category)
    {
