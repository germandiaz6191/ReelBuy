...
public partial class CategoriesIndex
{
    ...
    private Func<TableState, CancellationToken, Task<TableData<Category>>> LoadListAsync => async (state, cancellationToken) =>
    {
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = DialogService.Show<CategoryEdit>($"{Localizer["Edit"]} {Localizer["Category"]}", parameters, options);
        }
        else
        {
            dialog = DialogService.Show<CategoryCreate>($"{Localizer["New"]} {Localizer["Category"]}", options);
        }
