...
public partial class ReputationsIndex
{
    ...
    {
        var responseHppt = await Repository.GetAsync<List<Reputation>>("api/reputations");
        ...
        Reputations = responseHppt.Response!;
    }
    ...
    private async Task DeleteAsync(Reputation reputation)
    {
        var result = await SweetAlertService.FireAsync(new SweetAlertOptions
        {
            ...
            Text = string.Format(Localizer["DeleteConfirm"], Localizer["Reputation"], reputation.Score),
        ...
        var responseHttp = await Repository.DeleteAsync($"api/reputations/{reputation.Id}");
