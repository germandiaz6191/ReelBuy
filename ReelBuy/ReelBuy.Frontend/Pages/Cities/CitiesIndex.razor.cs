...
public partial class CitiesIndex
{
    ...
    private Func<TableState, CancellationToken, Task<TableData<City>>> LoadListAsync => async (state, cancellationToken) =>
    {
    ...
    private async Task DeleteAsync(City city)
    {
        var parameters = new DialogParameters
            {
                { "Message", string.Format(Localizer["DeleteConfirm"], city.Name) }
            };
