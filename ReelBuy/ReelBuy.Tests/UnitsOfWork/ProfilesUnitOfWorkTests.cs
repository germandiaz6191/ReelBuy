...
{
    public class ProfilesUnitOfWorkTests
    {
        [Fact]
        public void CanInstantiateProfilesUnitOfWork()
        {
            var genericRepo = new Mock<IGenericRepository<Profile>>();
            var repo = new Mock<IProfilesRepository>();
            var unitOfWork = new ProfilesUnitOfWork(genericRepo.Object, repo.Object);
        ...
        public async Task GetAsync_ShouldCallRepository()
        {
            var genericRepo = new Mock<IGenericRepository<Profile>>();
            var repo = new Mock<IProfilesRepository>();
            repo.Setup(r => r.GetAsync()).ReturnsAsync(new ReelBuy.Shared.Responses.ActionResponse<IEnumerable<Profile>>());
            var unitOfWork = new ProfilesUnitOfWork(genericRepo.Object, repo.Object);
        ...
        public async Task GetAsync_ById_ShouldCallRepository()
        {
            var genericRepo = new Mock<IGenericRepository<Profile>>();
            var repo = new Mock<IProfilesRepository>();
            repo.Setup(r => r.GetAsync(It.IsAny<int>())).ReturnsAsync(new ReelBuy.Shared.Responses.ActionResponse<Profile>());
            var unitOfWork = new ProfilesUnitOfWork(genericRepo.Object, repo.Object);
        ...
        public async Task GetComboAsync_ShouldCallRepository()
        {
            var genericRepo = new Mock<IGenericRepository<Profile>>();
            var repo = new Mock<IProfilesRepository>();
            repo.Setup(r => r.GetComboAsync()).ReturnsAsync(new List<Profile>());
            var unitOfWork = new ProfilesUnitOfWork(genericRepo.Object, repo.Object);
        ...
        public async Task GetAsync_WithPagination_ShouldCallRepository()
        {
            var genericRepo = new Mock<IGenericRepository<Profile>>();
            var repo = new Mock<IProfilesRepository>();
            repo.Setup(r => r.GetAsync(It.IsAny<ReelBuy.Shared.DTOs.PaginationDTO>())).ReturnsAsync(new ReelBuy.Shared.Responses.ActionResponse<IEnumerable<Profile>>());
            var unitOfWork = new ProfilesUnitOfWork(genericRepo.Object, repo.Object);
