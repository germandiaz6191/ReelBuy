...
{
    private readonly Mock<IGenericUnitOfWork<Department>> _mockUnitOfWork;
    private readonly Mock<IDepartmentsUnitOfWork> _mockDepartmentsUnitOfWork;
    private readonly DepartmentsController _controller;

    public DepartmentsControllerTests()
    {
        _mockUnitOfWork = new Mock<IGenericUnitOfWork<Department>>();
        _mockDepartmentsUnitOfWork = new Mock<IDepartmentsUnitOfWork>();
        _controller = new DepartmentsController(_mockUnitOfWork.Object, _mockDepartmentsUnitOfWork.Object);
    }
    ...
    {
        // Arrange
        var expectedList = new List<Department> { new Department { Id = 1, Name = "Test" } };
        _mockDepartmentsUnitOfWork.Setup(x => x.GetComboAsync()).ReturnsAsync(expectedList);
    ...
    {
        // Arrange
        var expectedResponse = new ActionResponse<IEnumerable<Department>>
        {
            WasSuccess = true,
            Result = new List<Department> { new Department { Id = 1, Name = "Test" } }
        };
        _mockDepartmentsUnitOfWork.Setup(x => x.GetAsync()).ReturnsAsync(expectedResponse);
    ...
    {
        // Arrange
        var expectedResponse = new ActionResponse<Department>
        {
            WasSuccess = true,
            Result = new Department { Id = 1, Name = "Test" }
        };
        _mockDepartmentsUnitOfWork.Setup(x => x.GetAsync(1)).ReturnsAsync(expectedResponse);
    ...
    public async Task GetAsync_WithPagination_ReturnsOkResult_WhenSuccess()
    {
        ...
        _mockDepartmentsUnitOfWork.Setup(x => x.GetAsync(pagination)).ReturnsAsync(expectedResponse);
    ...
    public async Task GetTotalRecordsAsync_ReturnsOkResult_WhenSuccess()
    {
        ...
        _mockDepartmentsUnitOfWork.Setup(x => x.GetTotalRecordsAsync(pagination)).ReturnsAsync(expectedResponse);
